...
import iconCompany from "../../assets/images/logo-green-with-name-01.png";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
          <div className="lg:flex lg:items-center lg:mb-0 mb-10">
            <div className="">
              <h4 className="text-brand-white text-base font-medium leading-6 mb-4 lg:text-left text-center">
                Contact Us
              </h4>
              <h2 className="text-brand-white font-manrope text-4xl font-semibold leading-10 mb-9 lg:text-left text-center">
                Reach Out To Us
              </h2>
            </div>
          </div>
          <div className="lg:max-w-xl w-full flex items-center justify-center  ">
            <div className="">
              <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4 rounded-md">
                <Link
                  to="/"
