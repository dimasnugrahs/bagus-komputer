      ...
      <div className="lg:px-32 py-16 bg-brand-primary">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <h2 className="text-3xl font-bold text-center mb-4 text-brand-white">
              Our clients feedback
            </h2>
            <p className="text-center text-brand-white mb-12">
              We provide all the advantage that can simplify all your financial
              and banking support without any further issues
            </p>
            <div class="lg:max-w-xl w-full flex items-center justify-center  bg-cover bg-no-repeat ">
              <div class="">
                <div class="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                  <img
                    src={iconCompany}
                    alt="Icon"
                    className="max-w-12 hover:shadow mb-4"
                  />
